...
@auth_router.post("/register", response_model=UserResponse, summary="회원가입")
async def register(
...
@auth_router.post("/login", response_model=TokenResponse, summary="로그인")
async def login(
...
@auth_router.get("/verify", response_model=UserResponse, summary="토큰 검증")
...
@auth_router.get("/me", response_model=UserResponse, summary="내 정보 조회")
